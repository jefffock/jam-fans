	...
	return (
		<div className="p-4 w-full h-full pb-20">
			<div className="flex flex-col items-center mt-10 p-4 mx-auto max-w-xl border rounded-xl text-gray-800">
				...
				<p className="text-lg  mb-6">When adding jams, the show and setlist data comes from:</p>

				<h2 className="text-2xl font-bold mb-2">Phish.net</h2>
				<p className="text-lg  mb-6">Phish, Trey Anastasio, TAB</p>
				<p className="text-lg mb-6">
					<a className="underline text-blue-700 hover:text-blue-800" href="https://phish.net/credits">
						Phish.net
					</a>{' '}
				...
				<ul className="text-lg m-6 text-left self-start">
					<li className="my-2">
						Eggy -{' '}
						<a href="https://thecarton.net" className="underline text-blue-700 hover:text-blue-800">
							thecarton.net
						</a>
					</li>
					<li className="my-2">
						Goose -{' '}
						<a href="https://elgoose.net" className="underline text-blue-700 hover:text-blue-800">
							elgoose.net
						</a>
					</li>
					<li className="my-2">
						Neighbor -{' '}
						<a href="https://www.neighbortunes.net" className="underline text-blue-700 hover:text-blue-800">
							neighbortunes.net
						</a>
					</li>
					<li className="my-2">
				...
				<p className="text-lg  mb-6">
					Thank you to the fans who created, maintain and update these sites. Check them out!
					<br />
					<br />
					They all use{' '}
					<a className="underline text-blue-700 hover:text-blue-800" href="https://songfishapp.com/">
						Songfish
					</a>
				...
				<p className="text-lg  mb-10 self-start">
					<a className="underline text-blue-700 hover:text-blue-800" href="https://www.setlist.fm/">
						Setlist.fm
					</a>{' '}
				...
				<p className="text-lg py-4">
					Artists, crew, staff, tapers, fans, friends and family of fans, and everyone else - thank you for
					playing your part in creating and sharing this music.{' '}
				</p>
			</div>
		</div>
	)
