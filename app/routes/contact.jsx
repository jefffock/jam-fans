	...
	return (
		<div className="w-100 h-100">
			<div className="p-4 bg-white border border-gray-200 rounded-lg shadow m-4 mt-6 w-80 flex flex-col justify-between mx-auto sm:px-6 ">
				...
				<h1 className="m-4">
					Open to all suggestions: new artists, design, wording, features, etc. Also, please let me know if
					you encounter any bugs or anything annoying. Thank you!
				</h1>
				<p className="mx-4 mb-4">
					Twitter:{' '}
					<a href="https://twitter.com/jeffphox" className="underline">
						@jeffphox
					</a>
				</p>
				<p className="mx-4">
