import { Link, Outlet, useNavigate, useLoaderData, useFetcher } from '@remix-run/react'
...
export default function Index({ supabase, session }) {
	const { artists, songs, sounds, title, count, user, profile, initialJams } = useLoaderData()
